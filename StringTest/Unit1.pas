...
begin
  Memo1.Lines.Text :=  StringReplace(Memo1.Lines.Text, eSearchText.Text,
    eReplaceText.Text, [rfIgnoreCase, rfReplaceAll])
end;
...
begin
  ...
  if number_pos = 0 then
    ShowMessage('Искомый текст не найден!')
  else
    ShowMessage('Текст найден, позиция: ' + IntToStr(number_pos))
end;
